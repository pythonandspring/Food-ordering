...
from customer.views import CustomLoginView, ResetPasswordView, ChangePasswordView
...
urlpatterns = [
    ...
    path('login/', CustomLoginView.as_view(redirect_authenticated_user=True, template_name='customer/login.html',
